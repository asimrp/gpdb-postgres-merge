...
RecordTransactionCommit(void)
{
	...
	if (markXidCommitted || isDtxPrepared)
	{
		 ...
		 * distributed trasaction.  Otherwise, it is possible that a commit
...
#endif
	{
		 ...
		 *
		 * Updaing CLOG and distributed log is not necessary on the QD if the
		 * distributed transaction didn't make any writes on the QD.
		 */
		if (markXidCommitted)
		{
			/*
